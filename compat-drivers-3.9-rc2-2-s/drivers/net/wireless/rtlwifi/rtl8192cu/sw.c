...
static struct usb_device_id rtl8192c_usb_ids[] = {
	...
	{RTL_USB_DEVICE(0x0df6, 0x0061, rtl92cu_hal_cfg)}, /*Sitecom-Edimax WLA-4001*/
	{RTL_USB_DEVICE(0x0df6, 0x0070, rtl92cu_hal_cfg)}, /*Sitecom WLA-2102 by Agostino Polizzano*/
